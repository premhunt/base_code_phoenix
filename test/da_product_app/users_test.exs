defmodule DaProductApp.UsersTest do
  ...
  describe "change and update user" do
    ...
    test "change_user/1 returns a user changeset" do
      assert %Ecto.Changeset{} = _changeset = Users.change_user(%User{})
    end
  end
