defmodule DaProductAppWeb.UserAuth do
  @moduledoc false
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_da_product_app_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      DaProductAppWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule DaProductAppWeb.PageLive do
        use DaProductAppWeb, :live_view

        on_mount {DaProductAppWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{DaProductAppWeb.UserAuth, :ensure_authenticated}] do
