...
#
#     PHX_SERVER=true bin/da_product_app start
#
...
if config_env() == :prod do
  ...
  config :da_product_app, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :da_product_app, DaProductApp.Mailer,
